package net.meilcli.hubber.toolchain.generator.dependencies
...
class DependenciesGeneratorPlugin : Plugin<Project> {
    ...
    companion object {
        ...
        private const val packageName = "net.meilcli.hubber.config"
    ...
    override fun apply(project: Project) {
        val outputDirectory = project.file("${project.buildDir}/generated/source/dependencies/main/net/meilcli/hubber/config")
